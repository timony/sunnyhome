...
public class Shelly1PMInfoCollector implements DeviceInfoCollector {
    ...
    public Shelly1PMInfoCollector(Device device, EventEntryManagerService eventEntryManagerService) {
        this.device = device;
